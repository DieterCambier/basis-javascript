...
//Toon het aantal artikelen in arrMandje bij het laden van de pagina.
spanAantal.innerText = arrMandje.length;
//Toon alle artikelen in arrMandje in ulMandje
...
for (const a of aBeschikbaar) {
    ...
    a.onclick = function () {
        ...
        spanAantal.innerText = arrMandje.length;
        //Voeg het laatste item in arrMandje toe als li element aan ulMandje.
